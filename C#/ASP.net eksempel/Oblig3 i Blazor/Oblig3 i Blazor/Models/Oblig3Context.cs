...
{
    public partial class Oblig3Context : DbContext
    {
        public Oblig3Context()
        {
        }

        public Oblig3Context(DbContextOptions<Oblig3Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("name=Dat154");
            }
        }
